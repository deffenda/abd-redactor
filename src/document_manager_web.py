...
app = FastAPI(
    title="ADB Document Manager Web API",
    version="1.0.0",
    description=(
        "Upload documents for AI detection, PDF redaction download, and model-generated "
        "document summaries."
    ),
)
...
<head>
  ...
  <title>ADB Document Manager</title>
  <style>
